...
function CoffeeShopPreviewCard({ name, address, id }) {
  ...
  return (
    <div className="bg-black text-white font-sans p-6 m-6 items-center rounded-xl hover:shadow-xl shadow-black transition ease-in-out delay-50 hover:-translate-y-1 ">
